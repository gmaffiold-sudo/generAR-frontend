    ...
    (async () => {
      try {
        ...
        if (res.ok) {
          ...
          setMessage(data?.detail || "El enlace de verificación no es válido o ha expirado.");
          setState("error");
        }
      } catch {
    ...
    <div style={{
      ...
      {state === "success" && (
        <div style={{
          ...
          <ActionButton href="/login">Ir al login</ActionButton>
        </div>
      )}
      ...
      {state === "no-token" && (
        <div style={{
          ...
          <p style={{
            ...
            No se encontró un token de verificación en el enlace. Verifica que copiaste el enlace completo desde tu correo.
          </p>
